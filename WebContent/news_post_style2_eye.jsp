 ...
 <div class="content">
                           <div class="separator" style="height:4px;"></div>
                                ...
                                <a href="#" class="pic w_frame alignleft"><img src="${ctx}/preViewImgUp/${premod1F1}" alt="" width="310px" height="130px"/></a>
                                 --%>
                                 <p style="width:600px;">
								    <img style="margin:10px;"src="${ctx}/preViewImgUp/${premod1F1}" align="left" width="120" hspace="5" vspace="5">
								    <i style="width: 100%; 
								    font-size:16px; 
								    height: auto;  
								    word-wrap:break-word;  
								    word-break:break-all;  
								    overflow: hidden;">${mod1textarea1}</i>
								</p>
								 <p style="width:600px;">
								    <img style="margin:10px;"src="${ctx}/preViewImgUp/${premod1F2}" align="right" width="120" hspace="5" vspace="5">
								    <i style="width: 100%; 
								    font-size:16px; 
								    height: auto;  
								    word-wrap:break-word;  
								    word-break:break-all;  
								    overflow: hidden;">${mod1textarea2}</i>
								</p>
								 <p style="width:600px;">
								    <img style="margin:10px;"src="${ctx}/preViewImgUp/${premod1F3}" align="left" width="120" hspace="5" vspace="5">
								    <i style="width: 100%; 
								    font-size:16px; 
								    height: auto;  
								    word-wrap:break-word;  
								    word-break:break-all;  
								    overflow: hidden;">${mod1textarea3}</i>
								</p>
							</div>
