										...
										<form id="Form_model3" class="am-form tpl-form-line-form" action="" method="post" enctype="multipart/form-data" target="">
									    	<c:choose>
											    <c:when test="${not empty OneNews and not empty OneNews.newsTitle}">
													...
													name="mod3title" value="${OneNews.newsTitle}"/>
											    </c:when>
											    <c:otherwise>
													<input style="font-size: 30px; padding: 10px; font-weight: bold; text-align: center; border: 1px solid #c2cad8;" 
													name="mod3title" value="这是题目"/>
											    </c:otherwise>
										    </c:choose>
											<div>
												<div style="padding: 10px; text-align: center;">
													...
													<div class="upload_box">
														...
														<div class="preview">
															<img class="imghead" src="${ctx}/assets/img/add.png" width="60%" />
														</div>
													</div>
													<!--input-group end-->
												</div>
												...
												<div class="am-u-sm-10">
													...
													<div class="upload_box">
														...
														<div class="preview" style="margin-top: 20px;">
															<img  class="" src="${ctx}/assets/img/add.png" width="60%"/>
														</div>
													</div>
													<!--input-group end-->
												</div>
