...
<p >
														<a href="#" class="pic_con_style_tu21"> 
															<img src="${ctx1}/newsImgUp/${modMixLR.mMixLRImgOne}" align="left"  width="265px" height="auto" vspace="5"/>
														</a>
														<i style="width: 100%; 
													    font-size:16px; 
													    height: auto;  
													    ...
													    overflow: hidden;">${modMixLR.mMixLRContentOne}</i>
													</p>
													<p>
														<a href="#" class="pic_con_style_tu22"> 
															<img src="${ctx1}/newsImgUp/${modMixLR.mMixLRImgTwo}" align="right" width="265px" height="auto"/>
														</a>
														${modMixLR.mMixLRContentTwo}
													</p>
													<p>
														<a href="#" class="pic_con_style_tu21"> 
															<img src="${ctx1}/newsImgUp/${modMixLR.mMixLRImgThree}" align="right" width="265px" height="auto"/>
														</a>
