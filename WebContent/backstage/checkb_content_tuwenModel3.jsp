        ...
        <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
            <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    <a href="userinfo.jsp">
                        <span class="tpl-header-list-user-nick">${bloginUser.loginName}</span><span class="tpl-header-list-user-ico"> 
                        <img src="${ctx1}/imgUp/${bloginUser.userInfo.headUrl}"></span>
                    </a>
                </li>
                <li>
									...
									<a href="#">
		                                <c:if test="${not empty OneNews.modMixSingles}">
		                               		<c:forEach items="${OneNews.modMixSingles}" var="modMixSingle">
		                               				<img src="${ctx1}/newsImgUp/${modMixSingle.mMixSingleImgOne}" alt="" width="100%" height="auto"/>
		                               		</c:forEach>
		                               	</c:if>									
									</a>
								</div>
